    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-auto border-t md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:max-w-md md:rounded-t-2xl",
          className
        )}
        {...props}
      >
